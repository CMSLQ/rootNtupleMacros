...
void analysisClass::Loop()
{
   ...
   //for (Long64_t jentry=0; jentry<10;jentry++) {
	 ...
	 if ( caloJetIC5Pt[ijet] < getPreCutValue1("jet_PtPreCut") ||  
	      fabs(caloJetIC5Eta[ijet]) > getPreCutValue1("jet_EtaPreCut") ) continue;
     ...
     //## nJet
     fillVariableWithValue( "nJet_PtEtaPreCut_DIS", v_idx_jet_final.size() ) ;
	 ...
	 fillVariableWithValue( "beta_ee", v_ee.Beta() ) ;
       }

     //## Mjj
     if( TwoJets ) 
       {
	 TLorentzVector v_jj, jet1, jet2;
	 ...
	 v_jj = jet1 + jet2;
	 fillVariableWithValue( "invMass_jj", v_jj.M() ) ;
	 fillVariableWithValue( "beta_jj", v_jj.Beta() ) ;
       }
	 ...
	 fillVariableWithValue("sT0", calc_sT);
	 fillVariableWithValue("sT1", calc_sT);
	 fillVariableWithValue("sT2", calc_sT);
	 fillVariableWithValue("sT3", calc_sT);
	 fillVariableWithValue("sT4", calc_sT);
 	 fillVariableWithValue("sT5", calc_sT);
 	 fillVariableWithValue("sT6", calc_sT);
 	 fillVariableWithValue("sT7", calc_sT);
 	 fillVariableWithValue("sT8", calc_sT);
 	 fillVariableWithValue("sT9", calc_sT);
 	 fillVariableWithValue("sT10", calc_sT);
 	 fillVariableWithValue("sT11", calc_sT);
 	 fillVariableWithValue("sT12", calc_sT);
 	 fillVariableWithValue("sT13", calc_sT);
 	 fillVariableWithValue("sT14", calc_sT);
       }
	 ...
	 double calc_sTele = 
	   elePt[v_idx_ele_final[0]]
	   + elePt[v_idx_ele_final[1]];
	 fillVariableWithValue("sTele", calc_sTele);
       }
	 ...
	 double calc_sTjets = 
	   caloJetIC5Pt[v_idx_jet_final[0]]
	   + caloJetIC5Pt[v_idx_jet_final[1]];
	 fillVariableWithValue("sTjets", calc_sTjets);
       }
